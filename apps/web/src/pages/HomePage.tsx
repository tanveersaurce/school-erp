    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col justify-between">
      ...
      <header className="border-b border-slate-800/80 bg-slate-900/60 backdrop-blur-md px-6 py-4 sticky top-0 z-40 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          <Link
            to="/communication"
            className="text-xs text-sky-300 hover:text-white font-medium mr-1"
          >
            Communication
          </Link>
          <Link
          ...
          <Link
            to="/inventory"
            className="text-xs text-emerald-400 hover:text-white font-medium mr-1"
          >
            Inventory
          </Link>
          <Link
          ...
          <Link
            to="/transport"
            className="text-xs text-amber-300 hover:text-white font-medium mr-1"
          >
            Transport
          </Link>
          <Link
